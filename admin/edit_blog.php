...
$article_info=$psd_array["article_info"];
}
?>
...
return window.confirm('是否要修改该博文?');
...
<body>
<form action="../action/blog_article.php?flag=edit&article_id=<?php echo $article_id  ?>" method="post" onSubmit="return check_form();">
<table width="900px" border="0" class="sty_table">
  ...
  <tr>
    ...
    <td><input type="text" name="article_title" id="article_title" value="<?php echo $article_name  ?>"></td>
  </tr>
  <tr>
<link rel="stylesheet" href="kindeditor/themes/default/default.css" />
    ...
    <td><textarea name="article_con" style="height:400px;" id="article_con"><?php echo $article_con  ?></textarea></td>
  </tr>
   <tr>
    <td align="center" valign="top">文章简介:</td>
    <td><textarea name="article_info" id="article_info"><?php echo $article_info  ?></textarea></td>
  </tr>
  <tr>
    <td align="center" valign="top">作者:</td>
    <td><input type="text" name="article_editor" id="article_editor" value="<?php echo $article_editor  ?>"  ></td>
  </tr>
  <tr>
    <td align="center" valign="top">修改时间:</td>
  ...
  <tr>
    ...
    <td>
    <?php  if($article_fenli=="生活")
	{
         echo "<select name='article_fenli'>
...
<input name="" type="submit" value="修改博客" />
