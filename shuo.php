...
<head>
<meta charset="UTF-8">
<title><?php echo $web_name; ?>-个人博客</title>
    ...
    <div id="say">
     <div class="weizi">
          ...
          <ul class="say_box">
                  ...
                  <span class="dateview">2016-5-28</span>
          </ul>
          <ul class="say_box">
                     <div class="sy">
                         <p> 过去就像回形针，把青春一页页的固定，然后变成了一本不被出版的书。</p>
                     </div>
                  <span class="dateview">2016-5-31</span>
          </ul>
          <ul class="say_box">
                     <div class="sy">
                  ...
                  <span class="dateview">2016-6-1</span>
          </ul>
          <ul class="say_box">
                     <div class="sy">
                         <p>青春，一半明媚，一半忧伤。
                  ...
                  <span class="dateview">2016-6-2</span>
          </ul>
     </div>
    <!--content end-->
    <!--footer-->
